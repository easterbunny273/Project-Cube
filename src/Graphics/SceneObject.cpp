...
void SceneObject::Render(std::shared_ptr<TItlRenderInfo> pCurrentRenderInfo)
{
...
bool SceneObject::ItlTestIfVisible()
{
    return true;
}

bool SceneObject::ItlTestSkipRendering()
{
    return false;
}

void SceneObject::AddChild(std::shared_ptr<SceneObject> spNode)
{
...
bool SceneObject::RemoveChild(std::shared_ptr<SceneObject> spNode)
{
    bool bFound = false;
...
void SceneObject::GetTransformMatrix(glm::mat4 &rToWorld, glm::mat4 &rFromWorld) const
{
    rToWorld = m_mTransformMatrixToWorld;
    rFromWorld = m_mTransformMatrixFromWorld;
}

void SceneObject::SetTransformMatrix(glm::mat4 rToWorld, glm::mat4 rFromWorld)
{
    m_mTransformMatrixToWorld = rToWorld;
    m_mTransformMatrixFromWorld = rFromWorld;
}

void SceneObject::SetTransformMatrix(glm::mat4 rToWorld)
{
    glm::mat4 mFromWorld;
