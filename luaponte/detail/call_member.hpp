...
#ifndef LUAPONTE_DETAIL_CALL_MEMBER_HPP
#define LUAPONTE_DETAIL_CALL_MEMBER_HPP
...
#include <luaponte/object.hpp> // TODO: REMOVE DEPENDENCY
...
//          friend class luaponte::object;
    ...
    #define BOOST_PP_ITERATION_PARAMS_1 (4, (0, LUAPONTE_MAX_ARITY, <luaponte/detail/call_member.hpp>, 1))
    #include BOOST_PP_ITERATE()

}

#endif // LUAPONTE_DETAIL_CALL_MEMBER_HPP
...
#define LUAPONTE_OPERATOR_PARAMS(z, n, data) const A##n & a##n
    ...
    typename boost::mpl::if_<boost::is_void<R>
            , luaponte::detail::proxy_member_void_caller<boost::tuples::tuple<BOOST_PP_ENUM(BOOST_PP_ITERATION(), LUAPONTE_TUPLE_PARAMS, _)> >
            , luaponte::detail::proxy_member_caller<R, boost::tuples::tuple<BOOST_PP_ENUM(BOOST_PP_ITERATION(), LUAPONTE_TUPLE_PARAMS, _)> > >::type
    call_member(object const& obj, const char* name BOOST_PP_COMMA_IF(BOOST_PP_ITERATION()) BOOST_PP_ENUM(BOOST_PP_ITERATION(), LUAPONTE_OPERATOR_PARAMS, _))
    {
        ...
        typedef typename boost::mpl::if_<boost::is_void<R>
            , luaponte::detail::proxy_member_void_caller<boost::tuples::tuple<BOOST_PP_ENUM(BOOST_PP_ITERATION(), LUAPONTE_TUPLE_PARAMS, _)> >
            , luaponte::detail::proxy_member_caller<R, boost::tuples::tuple<BOOST_PP_ENUM(BOOST_PP_ITERATION(), LUAPONTE_TUPLE_PARAMS, _)> > >::type proxy_type;
