...
#ifndef LUAPONTE_CLASS_HPP
#define LUAPONTE_CLASS_HPP
...
namespace luaponte {
    ...
    template <
        BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
            LUAPONTE_MAX_BASES, class A, detail::null_type)
    >
    struct bases
    {};
    ...
    namespace detail
    {
        ...
        template <BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_BASES, class A)>
        struct is_bases<bases<BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_BASES, A)> >
          : mpl::true_
        {};
        ...
        struct LUAPONTE_API create_class
        {
    ...
    namespace detail {
        ...
        struct LUAPONTE_API class_base : scope
        {
        public:
...
#define LUAPONTE_GEN_BASE_INFO(z, n, text) gen_base_info(detail::type_<BaseClass##n>());

        template<BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_BASES, class BaseClass)>
        void generate_baseclass_list(detail::type_<bases<BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_BASES, BaseClass)> >)
        {
            BOOST_PP_REPEAT(LUAPONTE_MAX_BASES, LUAPONTE_GEN_BASE_INFO, _)
        }

#undef LUAPONTE_GEN_BASE_INFO
        ...
        class_& def(char const* name, F fn, DefaultOrPolicies default_or_policies)
        {
            return this->virtual_def(
              ...
              , LUAPONTE_MSVC_TYPENAME detail::is_policy_cons<DefaultOrPolicies>::type());
        }
        ...
        template<BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_ARITY, class A)>
        class_& def(constructor<BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_ARITY, A)> sig)
        {
            return this->def_constructor(&sig, detail::null_type());
        }

        template<BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_ARITY, class A), class Policies>
        class_& def(constructor<BOOST_PP_ENUM_PARAMS(LUAPONTE_MAX_ARITY, A)> sig, const Policies& policies)
        {
