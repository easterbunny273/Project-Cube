...
#ifndef LUAPONTE_OBJECT_HPP
#define LUAPONTE_OBJECT_HPP
...
#define LUAPONTE_BINARY_OP_DEF(op, fn) \
...
LUAPONTE_BINARY_OP_DEF(==, LUA_OPEQ)
LUAPONTE_BINARY_OP_DEF(<, LUA_OPLT)
...
#undef LUAPONTE_BINARY_OP_DEF
  ...
  public:
      ...
      #define BOOST_PP_ITERATION_PARAMS_1 (3, \
          (3, LUAPONTE_MAX_ARITY, <luaponte/detail/object_call.hpp>))
  ...
  public:
      ...
      ~iterator_proxy()
      {
        ...
        iterator_proxy & operator=(luaponte::detail::nil_type)
        {
...
namespace adl
{
  ...
  public:
      ...
      operator object();
        ...
        // this will set the value to nil
        this_type& operator=(luaponte::detail::nil_type)
        {
...
#ifndef LUAPONTE_USE_VALUE_WRAPPER_TAG
template<class T>
...
namespace detail {
  ...
  )
  {
      ...
      if (cv.match(interpreter, LUAPONTE_DECORATE_TYPE(T), -1) < 0)
      {
          return ErrorPolicy::handle_error(interpreter, typeid(T));
      }

      return cv.apply(interpreter, LUAPONTE_DECORATE_TYPE(T), -1);
  }
...
namespace adl
{
  ...
  struct call_proxy
  {
      ...
      object call(Policies*)
      {
          ...
          {
#ifndef LUAPONTE_NO_EXCEPTIONS
              throw luaponte::error(interpreter);
#else
