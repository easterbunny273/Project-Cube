...
namespace BambooGraphics
{
    ...
    /****************************************************************
      *************************************************************** */
    void GraphicsCore::ICamera::SetOrthoProjection(float fLeft,
                                             float fRight,
                                             float fTop,
                                             float fBottom,
                                             float fNear,
    ...
    /****************************************************************
      *************************************************************** */
    void GraphicsCore::ICamera::SetPerspectiveProjection(float fFieldOfView,
                                                   float fAspectRatio,
                                                   float fNearPlane,
                                                   float fFarPlane)
    {
    ...
    /****************************************************************
      *************************************************************** */
    glm::mat4 GraphicsCore::ICamera::GetProjectionMatrix() const
    {
    ...
    /****************************************************************
      *************************************************************** */
    glm::mat4 GraphicsCore::ICamera::GetViewMatrix() const
    {
      return m_m4ViewMatrix;
    }

    glm::mat4 GraphicsCore::ICamera::GetTranslationMatrix() const
    {
    ...
    /****************************************************************
      *************************************************************** */
    void GraphicsCore::ICamera::RotateVertical(float fValue)
    {
    ...
    /****************************************************************
      *************************************************************** */
    void GraphicsCore::ICamera::RotateHorizontal(float fValue)
    {
    ...
    */
    /****************************************************************
      *************************************************************** */
    void GraphicsCore::ICamera::Move(float fFactor)
    {
    ...
    void GraphicsCore::ICamera::SetPosition(glm::vec3 vPosition)
    {
    ...
    /****************************************************************
      *************************************************************** */
    void GraphicsCore::ICamera::AddToMoveVector(glm::vec3 vVector)
    {
        m_v3MoveVector += vVector;
    }

    std::shared_ptr<GraphicsCore::ICamera> GraphicsCore::PerspectiveCamera::Create(float fFieldOfView,
                                                                      float fAspectRatio,
                                                                      float fNearPlane,
                                                                      float fFarPlane,
    ...
    {
        GraphicsCore::PerspectiveCamera *pCamera = new GraphicsCore::PerspectiveCamera();
        ...
        return std::shared_ptr<GraphicsCore::ICamera>(pCamera);
    }
