/*
 * header file for SceneObject_VolumeVisColorCube class
 * written by: Christian Möllinger <ch.moellinger@gmail.com>
 * 05/2011, Project "Bamboo Engine"
 */

#ifndef __bambooengine_sceneobject_volumevis_colorcube_header
#define __bambooengine_sceneobject_volumevis_colorcube_header
...
class SceneObject_VolumeVisColorCube : public SceneObject
{
public:
    /*! \name Constructor / Destructor */
    //@{
    SceneObject_VolumeVisColorCube(GLint iCullMode);
    ~SceneObject_VolumeVisColorCube();
    //@}
