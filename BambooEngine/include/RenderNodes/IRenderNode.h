...
namespace BambooGraphics
{
    ...
    */
    ...
    class GraphicsCore::IRenderNode
    {
    public:
        /*! \name Public types */
        //@{
        ...
        //@{
            void SetGraphicCore(GraphicsCore *pGraphicCore) { m_pGraphicCore = pGraphicCore; }
        //@}
        ...
        void SetLightSourceForShadowMapping(std::shared_ptr<GraphicsCore::ICamera> spShadowCaster, bool bSetForChildren = true);
    ...
    protected:
        ...
        void ItlSendTransformMatrices();		///<internal helper function which sends the current transormation matrices to the shader
            ...
            GraphicsCore * ItlGetGraphicCore();
        //@}
        ...
        std::shared_ptr<TItlRenderInfo> m_pCurrentRenderInfo;
            ...
            std::vector<std::shared_ptr<GraphicsCore::IRenderNode> > m_vChildren;
        ...
        bool m_bHasChildren;
            ...
            GraphicsCore         * m_pGraphicCore;
        //@}

    };

    class GraphicsCore::IRenderNode_Cullable : public GraphicsCore::IRenderNode, public GraphicsCore::IRenderNode::IHasVertices
    {
        friend class GraphicsCore::IRenderNode;
