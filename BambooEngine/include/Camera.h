...
namespace BambooGraphics
{
    ...
    class GraphicsCore::PerspectiveCamera : public GraphicsCore::ICamera
    {
    public:
        static std::shared_ptr<GraphicsCore::ICamera> Create(float fFieldOfView,
                                                      float fAspectRatio,
                                                      float fNearPlane,
                                                      float fFarPlane,
    ...
    class GraphicsCore::OrthogonalCamera : public GraphicsCore::ICamera
    {
    public:
        static std::shared_ptr<GraphicsCore::ICamera> Create(float fLeft,
                                                      float fRight,
                                                      float fTop,
                                                      float fBottom,
                                                      float fNear,
